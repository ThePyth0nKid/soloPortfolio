      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {PROJECTS.map((project) => (
            <div
              key={project.name}
              className="p-6 bg-white border border-slate-200 dark:bg-slate-900 dark:border-slate-800 rounded-xl hover:border-slate-300 dark:hover:border-slate-700 transition-colors"
            >
