...
export default function Projects() {
  return (
    <section id="projects" className="py-24 px-6 bg-slate-100/60 dark:bg-slate-900/30 theme-transition">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {PROJECTS.map((project) => (
            <div
              key={project.name}
              className="p-6 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl hover:border-slate-400 dark:hover:border-slate-700 theme-transition"
            >
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400 mb-3 leading-relaxed theme-transition">
                {project.description}
              </p>
