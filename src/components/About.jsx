      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="flex flex-wrap gap-2 pt-4">
          {['React', 'TypeScript', 'Python', 'Postgres', 'AI/ML', 'Design'].map((skill) => (
            <span
              key={skill}
              className="px-3 py-1 bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-md text-xs text-slate-700 dark:text-slate-300 transition-colors"
            >
              {skill}
            </span>
          ))}
