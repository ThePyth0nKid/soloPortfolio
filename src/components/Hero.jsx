  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center px-6 text-center">
      <div className="max-w-3xl space-y-6">
        <div className="inline-block px-3 py-1 bg-purple-500/10 border border-purple-500/30 rounded-full text-xs text-purple-600 dark:text-purple-400">
        ...
        <div className="flex gap-3 justify-center pt-4">
          ...
          <a
            href="#about"
            className="px-6 py-3 border border-slate-300 dark:border-slate-700 hover:border-slate-500 dark:hover:border-slate-500 rounded-lg font-medium transition-colors"
          >
            About me
          </a>
        </div>
