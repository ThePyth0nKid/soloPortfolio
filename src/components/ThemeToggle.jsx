...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="fixed top-4 right-4 z-50 w-10 h-10 flex items-center justify-center rounded-full border border-slate-300 dark:border-slate-700 bg-white/80 dark:bg-slate-900/80 backdrop-blur hover:border-slate-400 dark:hover:border-slate-500 transition-colors shadow-sm"
    >
      {isDark ? (
        // Sun icon
